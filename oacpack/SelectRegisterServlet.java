...
/**
 * Servlet implementation class SelectRegisterServlet
 */
@WebServlet("/SelectRegisterServlet")
public class SelectRegisterServlet extends HttpServlet {
	...
	try{
		...
		ses.setAttribute("roll_no", roll_no);
		ses.setAttribute("rank", rank);
		ses.setAttribute("course", course);
		ses.setAttribute("email_id", email_id);
		ses.setAttribute("name", candidate_name);
		ses.setAttribute("f_name", f_name);
		ses.setAttribute("m_name", m_name);
